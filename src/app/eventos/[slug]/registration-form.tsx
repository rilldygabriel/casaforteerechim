...
const EMPTY = { fullName: "", phone: "", attendanceDuration: "", notes: "", consent: false, completedEncounter: "" };

export default function RegistrationForm({ slug, enabled, variant = "standard" }: { slug: string; enabled: boolean; variant?: "standard" | "post-encounter" }) {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const result = (await response.json()) as { error?: string; message?: string; accepted?: boolean };
